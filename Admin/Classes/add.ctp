...
<div class="portlet">
    ...
    <div class="portlet-body">
        <div class="tabbable-bordered">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6">
                    <?= $this->Form->control('top_on_list', ['label' => ['text' => __(' Move the class at the top of the list.'), 'class' => 'mt-checkbox mt-checkbox-outline'], 'class' => 'form-control', 'type' => 'checkbox', 'default' => 1, 'templates' => 'form_bootstrap']) ?>
                </div>
            </div>
        </div>
    </div>
