    ...
    <div class="portlet-title">
        ...
        <div class="actions btn-set">
            ...
            <?= $this->Form->postLink($this->Html->tag('i', '', ['class' => 'fa fa-trash']).
                __(' Delete'), ['action' => 'delete', $announcement->id]+$pageNo, ['escape' => false, 'block' => true, 'class'=>'btn btn-danger', 'confirm' => __('Are you sure you want to delete announcement #{0}?', $announcement->id)]); ?>
        </div>
    </div>
