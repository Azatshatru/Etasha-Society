    ...
    <div class="portlet-title">
        ...
        <div class="actions btn-set">
            ...
            <?= $this->Form->button($this->Html->tag('i', '', ['class' => 'fa fa-check']).
                __(' Save Announcement'), ['escape' => false, 'class' => 'btn btn-success']); ?>
        </div>
    </div>
        ...
        <div class="tabbable-bordered">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6 in-row">
                    <?= $this->Form->control('top_on_list', ['label' => ['text' => __(' Move the announcement at the top of the list.'), 'class' => 'mt-checkbox mt-checkbox-outline'], 'class' => 'form-control', 'type' => 'checkbox', 'default' => 1, 'templates' => 'form_bootstrap']) ?>
                </div>
            </div>
			<div class="row">
				<div class="col-xs-12 col-sm-6 in-row">
                    <?= $this->Form->control('is_new', ['label' => ['text' => __(' New Announcement.'), 'class' => 'mt-checkbox mt-checkbox-outline'], 'class' => 'form-control', 'type' => 'checkbox', 'templates' => 'form_bootstrap']) ?>
                </div>
            </div>
			<div class="row">
				<div class="col-xs-12">
