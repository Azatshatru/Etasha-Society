...
<?= $this->Form->create($imageGallery, ['type' => 'file', 'context' => ['validator' => 'bulk']]); ?>
<div class="portlet">
    <div class="portlet-title">
        ...
        <div class="actions btn-set">
            ...
            <?= $this->Form->button($this->Html->tag('i', '', ['class' => 'fa fa-check']).
                __(' Save Bulk Images In Gallery'), ['escape' => false, 'class' => 'btn btn-success']); ?>
        </div>
    </div>
        ...
        <div class="tabbable-bordered">
            ...
            <div class="row">
             ...
             <div class="col-xs-12 col-sm-6">
                    ...
                    <?= $this->Form->control('photo_bulk[]', ['label' => ['text' => __('Image'), 'class' => 'control-label'], 'type' => 'file', 'required' => true, 'multiple', /*'templates' => 'form_bootstrap', 'templateVars' => ['virtualInput' => $file['virtualInput'], 'buttons' => $file['buttons'], 'control' => $file['control']]*/]) ?>
					<?= $this->Html->tag('div', __('Max Size: 16mb'), ['class' => 'msgCommon']); ?>
                </div>
			</div>
            <div class="row">
               
                <div class="col-xs-12 col-sm-6 in-row">
                    <?= $this->Form->control('top_on_list', ['label' => ['text' => __('Move the images at the top of the list.'), 'class' => 'mt-checkbox mt-checkbox-outline'], 'class' => 'form-control', 'type' => 'checkbox', 'default' => 1, 'templates' => 'form_bootstrap']) ?>
                </div>
            </div>
        </div>
    </div>
