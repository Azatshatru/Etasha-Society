    ...
    <div class="portlet-body">
        <div class="tabbable-bordered">
            <div class="row">
				...
				<div class="col-xs-12 col-sm-6">
                   <?= $this->Form->control('newsletter_category_id', ['label' => ['text' => __('Newsletter Category'), 'class' => 'control-label'], 'class' => 'form-control', 'options' => $newsletterCategories, 'empty' => __('Select Newsletter Category'), 'default' => 1, 'required' => true, 'templates' => 'form_bootstrap']); ?>
                </div>
            </div>
