...
<div class="container">
<div class="row">
	<div class="col-md-10"><?= $this->Flash->render() ?></div>
	</div>
	<div id="content"><br>
		<?php if(!empty($job)){ ?>
        	<div class="col-sm-12">
        	...
        	<div class="col-sm-12">
                ...
                <div class="row">
					<div class="col-sm-6">
                       ...
                       <?= $this->Form->control('job_name', ['label' => __('Apply For'), 'class' => 'form-control', 'value'=>$job->name,'disabled'=>true]); ?>
		...
		<p class="email_cls"><a href="mailto:email: etasha@etashasociety.org">etasha@etashasociety.org</a></p> </h4>
		<?php } ?>
        </div>
    </div>
...
$(document).on('click', '.tab-actions li a', function(){
	$('#job-id').val($(this).attr('data'));
});
